var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            hidden: false,
            title: '',
            description: '...and enden with lunch planned from noon to 2 PM at Konak - Governor`s residence. After the lunch they are supposed to go to Bistrik train station, and leave for Ilidza Spa. <BR> <BR> The program and the route have been set.',
            location: {
